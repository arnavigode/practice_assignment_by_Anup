...
const Carousel = ({ slides, interval = 5000, controls = false, indicators = false, autoPlay = true, width = 1000, height= 600 }) => {
    ...
    return (
        <div className="carousel" style={{ maxWidth : width , maxHeight: height}}>
            <div 
